        ...
        <section class="overflow-x-auto relative sm:rounded-lg mx-auto container">
            <header class="mx-auto py-2">
                <h2 class="text-lg font-medium text-gray-900">
                    {{ __('Insira os dados a serem atualizados.') }}
                </h2>
            ...
            <form method="POST" action="{{ route('vehicles.update', $vehicle->id) }}">
                ...
                <div>
                    ...
                    <x-text-input id="model" class="block mt-1 w-full" type="text" name="model" :value="old('model', $vehicle->model)" required autofocus />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="brand" class="block mt-1 w-1/3" type="text" name="brand" :value="old('brand', $vehicle->brand)" required />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="version" class="block mt-1 w-1/3" type="text" name="version" :value="old('version', $vehicle->version)" required />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="year" class="block mt-1 w-auto"
                                    type="number"
                                    name="year" required
                ...
                <div class="flex items-center justify-right mt-4">
                    <a class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150" href="{{ route('vehicles.index') }}">
                        {{ __('Cancelar') }}
                    </a>
